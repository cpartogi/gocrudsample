...
func TestUpdateTutorial(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			configureMock: func(
				...
				mockTutorial.
					On("UpdateTutorial", mock.Anything, mock.Anything).
					Return(nil)
			},
		},
		{
	...
	for _, testCase := range cases {
		t.Run(testCase.name, func(t *testing.T) {
			...
			req, err := http.NewRequest(echo.PUT, "/tutorials/93d899ef-b918-4a94-b7fb-c51df7c7e144",
